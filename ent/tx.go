...
func (tx *Tx) init() {
	...
	tx.PublisherPermission = NewPublisherPermissionClient(tx.config)
	tx.StorageFile = NewStorageFileClient(tx.config)
...
// applies a query, for example: CIWorkflowResult.QueryXXX(), the query will be executed
